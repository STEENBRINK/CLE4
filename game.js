...
function preload() {
    ...
    //game.load.image('ground_1x1', 'assets/platformer/fantasy-tileset.png');
    game.load.spritesheet('ground_1x1', 'assets/platformer/fantasy-tileset.png', 32, 32, 232);
    game.load.atlasXML('atlas1', 'assets/platformer/Tiles/tiles_spritesheet.png', 'assets/platformer/Tiles/tiles_spritesheet.xml');
...
function create() {
    ...
    game.add.sprite(100, 200, 'atlas1', 'box.png');
...
function createTileSelector() {
    ...
    var tileStrip = tileSelector.createMultiple(1, "box", 1);
